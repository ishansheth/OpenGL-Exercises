...
public:
  ...
  void setUniformValue(F& func,const std::string& name, Args&&...args)
  {
    func(glGetUniformLocation(ID, name.c_str()),std::forward<Args>(args)...);
  }
...
private:
    ...
    typedef void(*funcPtr)(GLint,GLsizei,const GLfloat*);

    funcPtr func1 = glUniform4fv;
